...
def test_stage62_bridge_contract_and_stable_startup_loader():
    ...
    assert "stage6-7-texture-animhandle-decimal-fix-20260816d" in bridge_text
    assert 'EXPECTED_BRIDGE_BUILD_ID = "stage6-7-texture-animhandle-decimal-fix-20260816d"' in runtime_text
