...
APP = ROOT / "src" / "forest_manager" / "app" / "species_mask_deep_uvgen_contract_stage5d22.py"
...
def test_versions_match():
    ...
    assert '"bridge_version":"0.9.36"' in bridge or '\\"bridge_version\\":\\"0.9.36\\"' in bridge
    assert 'EXPECTED_BRIDGE_VERSION = "0.9.36"' in runtime
