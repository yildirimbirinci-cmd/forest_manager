...
APP = ROOT / "src" / "forest_manager" / "app" / "cluster_mapping_stage5d8.py"
...
def test_versions_match():
    ...
    assert '"bridge_version":"0.9.23"' in bridge or '\\"bridge_version\\":\\"0.9.23\\"' in bridge
    assert 'EXPECTED_BRIDGE_VERSION = "0.9.23"' in runtime
